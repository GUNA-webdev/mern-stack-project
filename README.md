## Restaurant reservation system Project
 - This is a project that allows a user to make reservation in restaurant.  
 - In this project, I mainly worked on the **Frontend** part.

## Technologies Used in this project 
- Frontend - React (JSX),CSS,Bootstrap,React Icons
